 ...
 * @version 4.29.0
 * @since 07/02/2024
 * @param txtDescripcion es el label de descripción
 * @param txtPrecio para la fecha de salida
 * @param txtCantidad para la cantidad de artículos
 * @param conexion el obj conexion para llamar a los métodos
 */
...
public class ModificarAr extends JFrame {
	...
	/**
	 * El constructor,dónde se diseña y organiza el Jframe
	 */
	public ModificarAr() {
